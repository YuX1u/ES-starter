...
import com.Yux1u.starter.elastic.entity.PageInfo;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.Yux1u.starter.elastic.annocations.Id;
import com.Yux1u.starter.elastic.annocations.Index;
...
public class RepositoryHandler<T, ID> implements Repository<T, ID>, InvocationHandler {
    ...
    public Mono<T> queryById(ID id) {
        ...
        return Mono.create(sink -> {
            // 开启异步查询
            client.getAsync(
                    new GetRequest(indexName, id.toString()), RequestOptions.DEFAULT,
                    // 异步回调
    ...
    private String getID(T t) {
        if (t == null) {
            throw new RuntimeException(clazz.getName() + "实例不能为null！");
        }
        try {
